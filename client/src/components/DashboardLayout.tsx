...
const menuItems: MenuItem[] = [
  ...
  { icon: AlertCircle, label: "Pendências de Estoque", path: "/pendencias-estoque", adminOnly: true },
  ...
  { icon: FileCheck, label: "Alocação NFe (Manual)", path: "/alocacoes-nfe", adminOnly: true },
